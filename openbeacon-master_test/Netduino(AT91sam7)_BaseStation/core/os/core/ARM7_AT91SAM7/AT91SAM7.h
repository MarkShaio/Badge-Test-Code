...
#elif defined(__AT91SAM7S512__) || defined(__AT91SAM7X512__)
#define AT91C_ISRAM_SIZE         ((unsigned int) 0x00020000)    // Internal SRAM size in byte (64 Kbytes)
#define AT91C_IFLASH_SIZE        ((unsigned int) 0x00080000)    // Internal FLASH size in byte (256 Kbytes)
#define AT91C_IFLASH_PAGE_SIZE   ((unsigned int) 256)   // Internal FLASH Page Size: 256 bytes
#define AT91C_IFLASH_PAGE_SHIFT          8
#define AT91C_IFLASH_NB_OF_LOCK_BITS     ((unsigned int) 32)    // Internal FLASH Number of Lock Bits: 16
