...
#define LED_GREEN       	(1L<<22)   //27
#define LED_RED         	(1L<<23)   //28
...
#define OB0_CSN_ID      	0
#define OB0_IRQ_PIN     	(1L<<28)   //14   --
#define OB0_CE_PIN      	(1L<<27)   //19   --
#define OB0_CSN_PIN     	(1L<<12)   //21
#define OB0_LED_BEACON_GREEN	(1L<<27)   //6
#define OB0_LED_BEACON_RED	(1L<<28)   //7
...
#define SCK_PIN         	(1L<<18)   //22
#define MOSI_PIN        	(1L<<17)   //23
#define MISO_PIN        	(1L<<16)   //24

#define LED_BEACON_PIO		AT91C_BASE_PIOB //A
#define LED_BEACON_MASK		(OB0_LED_BEACON_GREEN|OB0_LED_BEACON_RED|OB1_LED_BEACON_GREEN|OB1_LED_BEACON_RED)

/*-------------------------------*/
/* External Button               */
/*-------------------------------*/
#define EXT_BUTTON_PIO		AT91C_BASE_PIOA   //B
...
/*-------------------------------*/
#define MAC_OID 0x0026DBUL
#define MAC_IAB 0x000D91UL
...
#define SD_SPI_MISO	(1L<<24)   //16
#define SD_SPI_MOSI	(1L<<23)   //17
#define SD_SPI_SCK	(1L<<22)   //18
