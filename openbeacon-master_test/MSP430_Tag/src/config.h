...
#define LEDBITS (BIT0+BIT1+BIT3);
#define LED1_LIT P1OUT&=~BIT0
#define LED2_LIT P1OUT&=~BIT1       // BIT2 --> BIT1
#define LED3_LIT P2OUT&=~BIT2       // LED3 moved to port 2.2
#define LED1_DIM P1OUT|=BIT0
#define LED2_DIM P1OUT	|=BIT1        // BIT2 --> BIT1
#define LED3_DIM P2OUT|=BIT2        // LED3 moved to port 2.2
...
#define CONFIG_PIN_CSN_HIGH P2OUT|=CSN;P1OUT|=BIT0		//POUT --> P2OUT
#define CONFIG_PIN_CSN_LOW P2OUT&=~CSN;P1OUT&=~BIT0		//POUT --> P2OUT
#define CONFIG_PIN_CE_HIGH P2OUT|=CE;P1OUT|=BIT1		//POUT --> P2OUT
#define CONFIG_PIN_CE_LOW P2OUT&=~CE;P1OUT&=~BIT1		//POUT --> P2OUT
